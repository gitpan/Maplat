...
sub new {
    ...
    if ( $class eq __PACKAGE__ ) {
        ...
        return Maplat::Server::Simple::CGI->new( @_[ 1 .. $#_ ] );
    }
...
sub setup_listener {
    ...
    my $temp = 1;
    ioctl (HTTPDaemon, 0x8004667E, \$temp); # set non-blockin
...
(c) 2008-2009 Rene Schickbauer: Adapted for Maplat Framework
