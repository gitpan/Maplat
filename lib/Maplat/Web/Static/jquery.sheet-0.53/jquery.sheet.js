...
var jS = jQuery.sheet = {
	...
	saveSheet: function() {
        ...
        // FIXME: This AJAX call has been changed by CAVAC,
        // because the original didn't seem to work in
        // combinatition with Perl CGI... i didn't find
        // out if the problem is in CGI or this code block,
        // but sending everything as "binary" seemed to fix
        // the problem
		jQuery.ajax({
			url: jS.s.urlSave,
